...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 15, 2019 lúc 10:52 AM
...
(6, 1, 'trông ngon quá', 5),
(7, 1, 'trông hấp dẫn thế', 5);
...
(5, 1, 150000, 'Sườn nướng Hàn Quốc'),
(5, 2, 40000, 'Súp Đậu phụ kho'),
(5, 3, 140000, 'Thịt nướng BBQ'),
(6, 4, 40000, 'Chả cá'),
(6, 5, 35000, 'Nem cá'),
(6, 6, 25000, 'Cháo cá'),
(6, 7, 30000, 'Cá thu tẩm bột chiên giòn'),
(7, 8, 40000, 'Sườn xào chua ngọt'),
(7, 9, 140000, 'Lẩu nướng'),
(7, 10, 45000, 'Gà rang muối'),
(7, 11, 15000, 'Đậu rán lướt ván'),
(8, 12, 20000, 'Gà rán KFC'),
(8, 13, 15000, 'Khoai tây chiên'),
(8, 14, 15000, 'Rau xào thịt bò'),
(8, 15, 20000, 'Cá thu rán tẩm bột');
...
(5, 'Nhà hàng Sườn Hàn Quốc', 'Quận 1, TP HCM', 'Nhà hàng Sườn Hàn Quốc phục vụ hầu hết các món truyền thống đặc trưng của xứ Kim Chi.', 'https://images.foody.vn/images/foody-album3-jpg-333-636035928235812809(1).jpg', 4),
(6, 'Nhà hàng Lão ngư Chả cá', '171 Thái Hà, quận Đống Đa, Hà Nội', 'Nhà hàng đệ nhất chả cá tại Hà Nội. Muốn thưởng thức chả cá tại Thủ Đô, nhất định bạn phải tới đây', 'https://cdn.jamja.vn/blog/wp-content/uploads/2017/06/lao-ngu-cha-ca-2.jpg', 0),
(7, 'Nhà hàng XANH GARDEN', 'Hoài Đức, Hà Nội', 'Một trong những địa điểm được ưu chuộng khi nhắc tới các nhà hàng ngon mà rẻ tại Hà Nội. Không gian được thiết kế thoải mái chắc chắn sẽ làm bạn hài lòng.', 'https://toplist.vn/images/800px/nha-hang-xanh-garden-226780.jpg', 1),
(8, 'Nhà hàng Nam Phương', 'đường Trần Phú, Hải Phòng', 'Địa điểm hấp dẫn nếu bạn muốn trải nghiệm ẩm thực tại thành phố cảng Hải Phòng.', 'https://media-cdn.tripadvisor.com/media/photo-s/06/3e/82/7e/nam-phuong-restaurant.jpg', 1);
