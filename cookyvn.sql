...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 14, 2019 lúc 08:50 PM
...
(4, 'Nhà hàng Sườn Hàn Quốc', 'Quận 1, TP HCM', 'Nhà hàng Sườn Hàn Quốc phục vụ hầu hết các món truyền thống đặc trưng của xứ Kim Chi.', 'https://images.foody.vn/images/foody-album3-jpg-333-636035928235812809(1).jpg', 0),
(9, 'Nhà hàng Lão ngư Chả cá', '171 Thái Hà, quận Đống Đa, Hà Nội', 'Nhà hàng đệ nhất chả cá tại Hà Nội. Muốn thưởng thức chả cá tại Thủ Đô, nhất định bạn phải tới đây', 'https://cdn.jamja.vn/blog/wp-content/uploads/2017/06/lao-ngu-cha-ca-2.jpg', 0),
(10, 'Nhà hàng XANH GARDEN', 'Hoài Đức, Hà Nội', 'Một trong những địa điểm được ưu chuộng khi nhắc tới các nhà hàng ngon mà rẻ tại Hà Nội. Không gian được thiết kế thoải mái chắc chắn sẽ làm bạn hài lòng.', 'https://toplist.vn/images/800px/nha-hang-xanh-garden-226780.jpg', 1),
(13, 'Nhà hàng Nam Phương', 'đường Trần Phú, Hải Phòng', 'Địa điểm hấp dẫn nếu bạn muốn trải nghiệm ẩm thực tại thành phố cảng Hải Phòng.', 'https://media-cdn.tripadvisor.com/media/photo-s/06/3e/82/7e/nam-phuong-restaurant.jpg', 0);
